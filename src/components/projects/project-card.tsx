...
const invoiceBadgeColors: Record<InvoiceStatus, string> = {
  ...
  void: "bg-red-100 text-red-600 dark:bg-red-900/40 dark:text-red-400",
  uncollectible: "bg-orange-100 text-orange-600 dark:bg-orange-900/40 dark:text-orange-400",
};
